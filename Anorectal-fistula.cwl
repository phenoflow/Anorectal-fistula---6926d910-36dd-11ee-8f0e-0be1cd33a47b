...
steps:
  ...
  anorectal-fistula---secondary:
    run: anorectal-fistula---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  anorectal-fistula-laying---secondary:
    run: anorectal-fistula-laying---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: anorectal-fistula---secondary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: anorectal-fistula-laying---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
